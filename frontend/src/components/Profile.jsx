...
//                     <h2 className="name">Ethan Mathew Hunt</h2>
...
//                     <h4 className="username">Bravo Echo 11</h4>
//                     <h4 className="dob">August 18, 1964</h4>
//                     <h4 className="gender">Male</h4>
//                     <h4 className="address">
//                         65C, Downtown, Manhattan, New York, United States of America - 10013
//                     </h4>
//                 </div>
//                 <p className="endLine">
//                     <hr
...
//                     <button className="profile-btn cancel-btn">Edit Profile</button>
//                     <button className="profile-btn edit-btn">Order History</button>
//                 </div>
//             </div>
//         </div>
//     );
...
import { Edit, Close, History } from "@mui/icons-material";
import React from "react";
